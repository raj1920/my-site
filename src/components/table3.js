                  ...
                  <>
                    <tr>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        >
                          <img
                            src="https://img.icons8.com/windows/32/26e07f/toggle-on.png"
                            alt="img"
                          />
                        </a>
                      </td>
                      ...
                      <td colspan="3" className="px-6 py-4 whitespace-nowrap">
                        <div className="w-full">
                          ...
                          <div className="flex justify-center p-4">
                            <div className="border-r-2 bordr-gray-500 px-4">
                              ...
                              <div className="py-4">
                                <label class="flex items-center py-2">
                                  ...
                                  />
                                  <div className="ml-2">
                                    <span class="text-md">All Access</span>
                                    <p className="text-xs text-gray-500">Can access all items</p>
                                  </div>
                                </label>
                                <label class="flex items-center py-2">
                                  <input
                                  ...
                                  />
                                  <div className="ml-2">
                                    <span class="text-md">Restricted Access</span>
                                    <p className="text-xs text-gray-500">Can access only assigned or created items</p>
                                  </div>
                                </label>
                              </div>
                            </div>
